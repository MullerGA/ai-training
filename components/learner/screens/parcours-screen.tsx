    ...
    <div className="grid w-full gap-6 px-4 py-8 md:px-6 xl:grid-cols-[1fr_320px] xl:px-8">
      <div className="space-y-6">
        <div className="text-caption flex items-center gap-2">
          ...
          <ChevronRight className="size-3" />
          <span className="font-medium text-[var(--slate-900)]">Bien formuler ses prompts</span>
        </div>

        <section>
          <div className="mb-2 flex items-center gap-2">
            <Badge variant="info">Module 2 sur 4</Badge>
          ...
          <div className="space-y-3 p-5">
            {[
              ...
              <div key={goal} className="flex items-start gap-3">
                ...
                <p className="text-sm text-[var(--slate-700)]">{goal}</p>
              </div>
            ))}
          </div>
        </article>
      ...
      <aside className="space-y-4">
        <article className="panel-card p-4">
          ...
          <p className="mb-3 text-3xl font-bold text-[var(--slate-900)]">60%</p>
        ...
        <article className="panel-card p-4">
          ...
          <ul className="space-y-2 text-sm text-[var(--slate-600)]">
            <li>
              <Clock3 className="mr-2 inline size-4" /> Durée · 20 min
            </li>
            <li>
